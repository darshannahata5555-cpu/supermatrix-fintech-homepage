(() => {
  ...
  if (!document.querySelector('script[src*="enhancements.js"]')) {
    const enhancementScript=document.createElement("script");enhancementScript.src="./enhancements.js?v=8";enhancementScript.async=false;document.head.appendChild(enhancementScript);
  }
