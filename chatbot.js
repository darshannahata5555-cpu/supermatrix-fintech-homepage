(() => {
  if (!document.querySelector('link[href*="enhancements.css"]')) {
    const stylesheet=document.createElement("link");stylesheet.rel="stylesheet";stylesheet.href="./enhancements.css?v=1";document.head.appendChild(stylesheet);
  }
  if (!document.querySelector('script[src*="enhancements.js"]')) {
    const enhancementScript=document.createElement("script");enhancementScript.src="./enhancements.js?v=1";enhancementScript.defer=true;document.head.appendChild(enhancementScript);
  }
  ...
  const knowledge = [
    ...
    { id:"start", keys:["start investing","how to invest","getting started","onboarding","register","registration"], answer:"Start by defining your goal, timeframe, and comfort with risk. Contact the SuperMatrix team for the confirmed onboarding route, applicable KYC process, product information, and transaction assistance.", link:["Contact the team","index.html#contact"], suggestions:["What documents do I need?","What is KYC?","Direct vs Regular Plans","Use financial calculators"] },
    ...
    { id:"track", keys:["track investments","portfolio status","sip status","download statement","statements","portfolio login"], answer:"Contact SuperMatrix support for the confirmed portfolio-access route, SIP status, statements, and available reports. The public website does not currently publish a verified software login URL.", link:["Open Support Centre","support.html"], contact:true },
    ...
    { id:"redeem", keys:["redeem","redemption","withdraw investment","withdraw money"], answer:"Contact support or use the confirmed authorised transaction route to place a redemption request. Processing time varies by scheme and request type; exit load and tax may apply.", link:["Get service assistance","support.html"], contact:true },
    { id:"complaint", keys:["complaint","grievance","escalation","scores","not resolved"], answer:"Start with SuperMatrix support and retain your correspondence. The grievance page explains the available internal and external escalation routes, including SEBI SCORES where applicable.", link:["View grievance process","grievance.html"] },
